...
## Corpus Check
- 47 files · ~115,487 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 371 nodes · 595 edges · 33 communities (32 shown, 1 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `82e33a64`
...
2. `Utility Core — Registro de cambios` - 25 edges
...
Cohesion: 0.08
Nodes (25): 0.0.1-beta.1, 0.0.1-beta.2, 0.0.1-beta.3, 0.0.1-beta.4, 0.0.1-beta.5, 0.0.1-beta.6, 1.0.14, 1.0.15 (+17 more)
...
Cohesion: 0.11
Nodes (20): BooleanValue, Builder, CallbackInfoReturnable, DamageType, IntValue, Method, ModConfigSpec, Redirect (+12 more)
...
## Knowledge Gaps
- **76 isolated node(s):** `1.0.38`, `1.0.37`, `1.0.36`, `1.0.35`, `1.0.34` (+71 more)
...
- **Why does `PolymorphClientHandler` connect `PolymorphClientHandler.java` to `MixinItemInput.java`, `PlayerRecipeData`, `SyncRecipesPacket`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `PlayerRecipeData` connect `PlayerRecipeData` to `PolymorphApi.java`, `SyncRecipesPacket`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **What connects `1.0.38`, `1.0.37`, `1.0.36` to the rest of the system?**
