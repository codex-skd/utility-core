# Graph Report - utility_core  (2026-07-25)

## Corpus Check
- 48 files · ~115,756 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 375 nodes · 603 edges · 34 communities (33 shown, 1 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11efd97c`
...
2. `Utility Core — Registro de cambios` - 26 edges
...
Cohesion: 0.07
Nodes (26): 0.0.1-beta.1, 0.0.1-beta.2, 0.0.1-beta.3, 0.0.1-beta.4, 0.0.1-beta.5, 0.0.1-beta.6, 1.0.14, 1.0.15 (+18 more)
...
## Knowledge Gaps
- **77 isolated node(s):** `1.0.39`, `1.0.38`, `1.0.37`, `1.0.36`, `1.0.35` (+72 more)
...
- **What connects `1.0.39`, `1.0.38`, `1.0.37` to the rest of the system?**
