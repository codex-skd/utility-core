...
public class ModAttachments {
    ...
    public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES =
            DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES, "utility_core_qol");
    ...
    public static Supplier<AttachmentType<PlayerRecipeData>> getPlayerRecipeData() {
        return PLAYER_RECIPE_DATA;
    }
}