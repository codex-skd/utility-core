...
import com.skd.utilitycore.hud.UtilityCoreHud;
...
@Mod(value = UtilityCoreHud.MODID, dist = Dist.CLIENT)
public class UtilityCoreHudClient {

    public UtilityCoreHudClient(IEventBus modEventBus) {
        modEventBus.addListener(this::onClientSetup);
        NeoForge.EVENT_BUS.addListener(this::onRegisterCommands);
        NeoForge.EVENT_BUS.addListener(UtilityCoreHudClient::onRenderGui);
    }
